...
```{r}
FallinPlantChemistry1$Al <- as.factor(FallinPlantChemistry1$Al)
```


```{r}
Fallin.Al <- renyicomp(FallinPlantSpecies1, y=FallinPlantChemistry1, factor = 'Al',
scales=c(0, 0.25, 0.5, 1, 2, 4, 8, Inf), permutations=100, plotit=F)
```
...
```{r}
AddiewellPlantChemistry1$Al <- as.factor(AddiewellPlantChemistry1$Al)
```


```{r}
Addiewell.Al <- renyicomp(FallinPlantSpecies1, y=AddiewellPlantChemistry1, factor = 'Al',
scales=c(0, 0.25, 0.5, 1, 2, 4, 8, Inf), permutations=100, plotit=F)
```


```{r}
summary(Addiewell.Al)
```
...
```{r}
PenicuikPlantChemistry1$Al <- as.factor(PenicuikPlantChemistry1$Al)
```


```{r}
Penicuik.Al <- renyicomp(FallinPlantSpecies1, y=PenicuikPlantChemistry1, factor = 'Al',
scales=c(0, 0.25, 0.5, 1, 2, 4, 8, Inf), permutations=100, plotit=F)
```
...
```{r}
CarnforthPlantChemistry1$Al <- as.factor(CarnforthPlantChemistry1$Al)
```

```{r}
Carnforth.Al <- renyicomp(CarnforthPlantSpecies1, y=CarnforthPlantChemistry1, factor = 'Al',
scales=c(0, 0.25, 0.5, 1, 2, 4, 8, Inf), permutations=100, plotit=F)
```

```{r}
summary(Carnforth.Al)
```
...
```{r}
HodbarrowPlantChemistry1$Al <- as.factor(HodbarrowPlantChemistry1$Al)
```


```{r}
Hodbarrow.Al <- renyicomp(HodbarrowPlantSpecies1, y=HodbarrowPlantChemistry1, factor = 'Al',
scales=c(0, 0.25, 0.5, 1, 2, 4, 8, Inf), permutations=100, plotit=F)
```

```{r}
summary(Hodbarrow.Al)
```
